...
<div class="main2 text-center"> List of Transactions </div>
<br>
<br>
<?php
    ...
    while($res=mysqli_fetch_array($query))
    {
        ...
        <div class="animate__animated animate__backInLeft animate__delay-0.5s main"><?php echo $res[0] ?> transafered ₹<?php echo $res[2] ?> to <?php echo $res[1] ?> on <?php echo date("d-m-Y") ?> at <?php echo date("h:i:sa") ?></div>
